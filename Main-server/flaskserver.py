...
def getQR():
    ...
    if request.method == 'POST':
        ...
        return render_template('TicketGenerator.html', errors=errors, result=result, adult=adult, child=child, billNo=ticket_num, adult_total= str(int(adult)*150), child_total= str(int(child)*75), total=str(int(adult) * 150 + int(child) * 75))
